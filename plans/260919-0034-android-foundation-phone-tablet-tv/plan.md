...
| # | Phase | Status |
|---|---|---|
| 0 | [grammers-on-Android spike](phase-00-grammers-android-spike.md) | Not started |
| 1 | [`mediagram-core` and the UniFFI surface](phase-01-mediagram-core-and-uniffi.md) | Blocked by 0 |
| 2 | [Gradle skeleton, module graph, CI](phase-02-gradle-skeleton-and-ci.md) | Blocked by 0 |
| 3 | [Login and catalog; the mobile surface](phase-03-login-and-catalog-mobile.md) | Blocked by 1, 2 |
| 4 | [The TV surface](phase-04-tv-surface.md) | Blocked by 3 |
| 5 | [Playback on all three](phase-05-playback-media3.md) | Blocked by 3 |
| 6 | [Byte-truth gate and documentation](phase-06-byte-truth-gate-and-docs.md) | Blocked by 4, 5 |

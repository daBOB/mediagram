...
|---|---|---|---|
| 1 | [phase-01-move-shared-rules-out-of-ui-mobile.md](phase-01-move-shared-rules-out-of-ui-mobile.md) | Pure rules + lifecycle glue reachable by both surfaces | pending |
| 2 | [phase-02-tv-foundation-theme-and-shell.md](phase-02-tv-foundation-theme-and-shell.md) | tv-material, 10-foot theme, overscan, `TvApp` shell replaces placeholder | pending |
...
Order: 1 → 2 → 3 → 4 → 5 → 6. Phase 3 and 4 could swap, but setup must work before a real catalog appears on the emulator.

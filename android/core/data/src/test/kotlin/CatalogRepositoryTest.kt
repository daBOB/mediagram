...
class CatalogRepositoryTest {
    ...
    fun refreshWithoutCredentialsFails() = runTest {
        val repo = DefaultCatalogRepository(ResolvedCoreProvider(FakeCore()), InMemoryPackageSettings())
    ...
    fun setsMapKindFromTheCoreSurface() = runTest {
        ...
        val repo = DefaultCatalogRepository(ResolvedCoreProvider(core), settingsWithCredentials())

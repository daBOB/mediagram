   ...
   internal fun setValue(other: RustBuffer) {
    ...
    companion object {
        internal fun alloc(size: ULong = 0UL) = uniffiRustCall() { status ->
            ...
            UniffiLib.ffi_mediagram_core_rustbuffer_alloc(size.toLong(), status)
        }.also {
            if(it.data == null) {
        ...
        internal fun free(buf: RustBuffer.ByValue) = uniffiRustCall() { status ->
            UniffiLib.ffi_mediagram_core_rustbuffer_free(buf, status)
        }
    }
...
internal object IntegrityCheckingUniffiLib {
    init {
        Native.register(IntegrityCheckingUniffiLib::class.java, findLibraryName(componentName = "mediagram_core"))
...
internal object UniffiLib {
    ...
    external fun ffi_mediagram_core_rust_future_cancel_u8(`handle`: Long,
    ): Unit
    ...
    external fun ffi_mediagram_core_rust_future_cancel_i8(`handle`: Long,
    ): Unit
    ...
    external fun ffi_mediagram_core_rust_future_cancel_u16(`handle`: Long,
    ): Unit
    ...
    external fun ffi_mediagram_core_rust_future_cancel_i16(`handle`: Long,
    ): Unit
    ...
    external fun ffi_mediagram_core_rust_future_cancel_u32(`handle`: Long,
    ): Unit
    ...
    external fun ffi_mediagram_core_rust_future_cancel_i32(`handle`: Long,
    ): Unit
    ...
    external fun ffi_mediagram_core_rust_future_cancel_u64(`handle`: Long,
    ): Unit
    ...
    external fun ffi_mediagram_core_rust_future_cancel_i64(`handle`: Long,
    ): Unit
    ...
    external fun ffi_mediagram_core_rust_future_cancel_f32(`handle`: Long,
    ): Unit
    ...
    external fun ffi_mediagram_core_rust_future_cancel_f64(`handle`: Long,
    ): Unit
    ...
    external fun ffi_mediagram_core_rust_future_cancel_rust_buffer(`handle`: Long,
    ): Unit
    ...
    external fun ffi_mediagram_core_rust_future_cancel_void(`handle`: Long,
    ): Unit
...
private fun uniffiCheckContractApiVersion(lib: IntegrityCheckingUniffiLib) {
    ...
    val scaffolding_contract_version = lib.ffi_mediagram_core_uniffi_contract_version()
...
open class Core: Disposable, AutoCloseable, CoreInterface
{
    ...
    private class UniffiCleanAction(private val handle: Long) : Runnable {
        override fun run() {
            ...
            uniffiRustCall { status ->
                UniffiLib.uniffi_mediagram_core_fn_free_core(handle, status)
            }
        }
    }
     ...
     * Whether a login has ever completed. Reads the persisted auth key
     * only: cheap, and needs no connection.
     */override fun `isAuthorized`(): kotlin.Boolean {
            return FfiConverterBoolean.lift(
    callWithHandle {
    uniffiRustCall() { _status ->
    UniffiLib.uniffi_mediagram_core_fn_method_core_is_authorized(
        it,
        _status)
}
    }
    ...
    override suspend fun `signIn`(`token`: kotlin.String, `code`: kotlin.String) : AuthOutcome {
        ...
        { future -> UniffiLib.ffi_mediagram_core_rust_future_free_rust_buffer(future) },
        // lift function
        { FfiConverterTypeAuthOutcome.lift(it) },
        // Error FFI converter
        CoreException.ErrorHandler,
    )
    }
 ...
 * @suppress
 */
public object FfiConverterTypeSetSummary: FfiConverterRustBuffer<SetSummary> {
    ...
    override fun allocationSize(value: SetSummary) = (
 ...
 * @suppress
 */
public object FfiConverterTypeAuthOutcome: FfiConverterRustBuffer<AuthOutcome> {
    override fun read(buf: ByteBuffer) = try {
        AuthOutcome.values()[buf.getInt() - 1]
    } catch (e: IndexOutOfBoundsException) {
        throw RuntimeException("invalid enum value, something is very wrong!!", e)
    }

    override fun allocationSize(value: AuthOutcome) = 4UL

    override fun write(value: AuthOutcome, buf: ByteBuffer) {
...
public object FfiConverterTypeCoreError : FfiConverterRustBuffer<CoreException> {
    override fun read(buf: ByteBuffer): CoreException {
        ...
        return when(buf.getInt()) {
            ...
            2 -> CoreException.NotAuthorized(
                FfiConverterString.read(buf),
                )
            3 -> CoreException.NotFound(
                FfiConverterString.read(buf),
                )
            4 -> CoreException.Cipher(
                FfiConverterString.read(buf),
                )
            5 -> CoreException.Io(
                FfiConverterString.read(buf),
    ...
    override fun allocationSize(value: CoreException): ULong {
        return when(value) {
            ...
            is CoreException.NotAuthorized -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
                + FfiConverterString.allocationSize(value.v1)
            )
...
public object FfiConverterSequenceTypeSetSummary: FfiConverterRustBuffer<List<SetSummary>> {
    override fun read(buf: ByteBuffer): List<SetSummary> {
        val len = buf.getInt()
        return List<SetSummary>(len) {
            FfiConverterTypeSetSummary.read(buf)
        }
    }

    override fun allocationSize(value: List<SetSummary>): ULong {
        val sizeForLength = 4UL
        val sizeForItems = value.map { FfiConverterTypeSetSummary.allocationSize(it) }.sum()
        return sizeForLength + sizeForItems
    }

    override fun write(value: List<SetSummary>, buf: ByteBuffer) {
        buf.putInt(value.size)
        value.iterator().forEach {

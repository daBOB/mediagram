...
class CatalogueColorsTest {
    ...
    fun everyRoleComesFromThePalette() {
        val ours = setOf(
            Palette.Ground, Palette.Page, Palette.Sunk, Palette.Text, Palette.Figures,
            Palette.Rule, Palette.RuleStrong, Palette.Imprint, Palette.Ochre, Palette.Sage,
        )
     ...
     */
    private fun rolesOf(scheme: androidx.compose.material3.ColorScheme) = listOf(

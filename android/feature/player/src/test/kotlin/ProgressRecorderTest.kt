...
class ProgressRecorderTest {
     ...
     */
    @Test
    fun aGlanceIsStillSavedAsProgress() = runTest {
    ...
    @Test
    fun theCreditsClearProgressAndMarkTheTitleWatched() = runTest {
        val repository = FakeWatchStateRepository()
        val recorder = ProgressRecorder(repository)
    ...
    @Test
    fun anUnknownRuntimeKeepsThePositionRatherThanFinishing() = runTest {
        val repository = FakeWatchStateRepository()
        val recorder = ProgressRecorder(repository)
    ...
    @Test
    fun aTitleAlreadyWatchedIsNotReStampedOnAnotherFinish() = runTest {
        val repository = FakeWatchStateRepository(

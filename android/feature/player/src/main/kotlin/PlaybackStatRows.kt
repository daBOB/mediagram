 ...
 */
private fun languageLabel(tag: String): String = Locale.forLanguageTag(tag).getDisplayLanguage(Locale.ENGLISH)
...
fun audioStatLine(
    ...
    channels: Int,
    language: String,
): String = listOfNotNull(codecLabel(codec), CHANNEL_LABELS[channels], languageLabel(language)).joinToString(" ")

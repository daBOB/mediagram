...
/// The one reader of this table: a title's entry, or `None` when nothing
/// has been recorded for it. Films and series are numbered independently,
/// so `kind` is half the key.

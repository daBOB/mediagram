...
/// Where a stream's bytes come from. [`super::source::TelegramSource`] is
...
/// The document of a part's message, resolved by message id. Callers go
/// through [`super::documents::PartDocuments`], which holds it per set.

...
```json
{"format":1,"created_at":1781568000,"file":"prebuilt_mediagram_db_20260616-3d7e10c4.tar.gz.enc","url":"https://example.com/prebuilt_mediagram_db_20260616-3d7e10c4.tar.gz.enc","bytes":8127744,"sha256":"…64 hex…","cipher":"aes-256-gcm","key_id":"630dcd29","schema":9,"spec":4}
```
...
```json
{"format":1,"created_at":1781568000,"schema":9,"spec":4,"sets":312,"parts":468,"posters":[{"key":"tmdb-movie-693134","file":"posters/tmdb-movie-693134.jpg"}]}
```
...
```json
{"format":1,"created_at":1781568000,"key_id":"630dcd29","schema":9,"spec":4}
```

...
import { installShutdownSignals, shutdownFor, syncOnce, type ApplicationResources } from "./application/lifecycle";
import { WriteDebounce } from "./application/write-debounce";
import { announcingPulls } from "./application/lifecycle";
            ...
            return {
              ...
              transcodes: {
                ...
                sessions: transcodes.list().map(({ setId, seekSeconds, maxrateBits, audioTrack, watchers }) => ({
                  setId, seekSeconds, maxrateBits, audioTrack, watchers,
                })),
              },
              telegramConnected: connection.current()?.connected ?? null,
